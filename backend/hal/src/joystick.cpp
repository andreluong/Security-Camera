...
Joystick::Joystick(PanTiltKit& kit, Alarm& a) 
    : is_running(true), i2c_file_desc(0), panTiltKit(kit), alarm(a), joystickLine(GpioLine(JOYSTICK_GPIO_CHIP, JOYSTICK_LINE_NUM)) {
