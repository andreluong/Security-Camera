...
export default function ControlBar({
  ...
  return (
    <div className='flex flex-row justify-center gap-4 p-4 text-black bg-white border-4 border-t-0 border-black'>
		...
		<button className='btn gradient-text-transition' onClick={() => sendCommand("alarm")}>
			Alarm
		</button>
		<button className='btn' onClick={() => sendCommand("up")}>
			<Icon className='hover:text-[#ff0000]' icon="material-symbols:arrow-upward-alt" width="28" height="28" />
		</button>
		<button className='btn' onClick={() => sendCommand("down")}>
			<Icon className='hover:text-[#ff0000]' icon="material-symbols:arrow-downward-alt" width="28" height="28" />
		</button>
		<button className='btn gradient-text-transition' onClick={() => sendCommand("left")}>
			<Icon className='hover:text-[#ff0000]' icon="material-symbols:arrow-left-alt" width="28" height="28" />
		</button>
		<button className='btn gradient-text-transition' onClick={() => sendCommand("right")}>
			<Icon className='hover:text-[#ff0000]' icon="material-symbols:arrow-right-alt" width="28" height="28" />
		</button>
    </div>
  )
}
